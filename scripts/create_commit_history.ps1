...
if (-not (Get-Command git -ErrorAction SilentlyContinue)) {
    ...
    Write-Host "Install Git for Windows, close PowerShell, open it again, then rerun this script." -ForegroundColor Yellow
...
Commit-Paths "2026-06-04T20:15:00+03:30" $AYDIN_NAME $AYDIN_EMAIL `
...
Commit-Paths "2026-06-06T21:10:00+03:30" $AYDIN_NAME $AYDIN_EMAIL `
...
Commit-Paths "2026-06-08T19:40:00+03:30" $AYDIN_NAME $AYDIN_EMAIL `
...
Commit-Paths "2026-06-10T22:05:00+03:30" $AYDIN_NAME $AYDIN_EMAIL `
...
Commit-Paths "2026-06-12T20:55:00+03:30" $MOHSEN_NAME $MOHSEN_EMAIL `
...
Commit-Paths "2026-06-20T20:20:00+03:30" $MOHSEN_NAME $MOHSEN_EMAIL `
...
Commit-Paths "2026-06-22T22:45:00+03:30" $MOHSEN_NAME $MOHSEN_EMAIL `
...
Commit-Paths "2026-06-24T21:35:00+03:30" $SEPEHR_NAME $SEPEHR_EMAIL `
...
Commit-Paths "2026-06-26T19:50:00+03:30" $SEPEHR_NAME $SEPEHR_EMAIL `
    "Add pin labels and advanced component UI details" `
    @("PIN_LABELS_AND_PUSHBUTTON_OUTPUT_NOTES.md", "KEYPAD_MCU_MEMORY_FIX_NOTES.md")

Commit-Paths "2026-06-28T22:20:00+03:30" $MOHSEN_NAME $MOHSEN_EMAIL `
...
Commit-Paths "2026-06-30T23:00:00+03:30" $MOHSEN_NAME $MOHSEN_EMAIL `
...
Commit-Paths "2026-07-01T20:30:00+03:30" $AYDIN_NAME $AYDIN_EMAIL `
...
Commit-Paths "2026-07-03T21:15:00+03:30" $SEPEHR_NAME $SEPEHR_EMAIL `
    "Add final test circuits and firmware files" `
    @("tests")

Commit-Paths "2026-07-04T23:30:00+03:30" $AYDIN_NAME $AYDIN_EMAIL `
...
# Add remaining files not covered above.
git add .
if ($LASTEXITCODE -ne 0) { throw "git add remaining files failed" }

git diff --cached --quiet
if ($LASTEXITCODE -ne 0) {
    $env:GIT_AUTHOR_NAME = "Aydin"
    $env:GIT_AUTHOR_EMAIL = "AydinEZP@gmail.com"
    $env:GIT_AUTHOR_DATE = "2026-07-04T23:45:00+03:30"
    $env:GIT_COMMITTER_NAME = "Aydin"
    $env:GIT_COMMITTER_EMAIL = "AydinEZP@gmail.com"
    $env:GIT_COMMITTER_DATE = "2026-07-04T23:45:00+03:30"
    git commit -m "Add remaining project assets"
    if ($LASTEXITCODE -ne 0) { throw "final git commit failed" }
}
...
Write-Host "History is ready." -ForegroundColor Green
